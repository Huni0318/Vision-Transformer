...
if __name__ == "__main__":
    ...
    mlp_hidden_dim = int(latent_vec_doim/2)
    ...
    if args.mode == 'train':
        ...
        #optimizer = torch.optim.SGD(vit.parameters(), lr = args.lr, moment=0.9)
        #scheduler = optim.lr_scheduler.OneCycleLR(optimizer, max_lr = args.lr, step_per_epoch=len(trianloader), epochs = args.epochs)
        ...
        train_acc, train_loss = test.accuracy(trainloader, vit)
